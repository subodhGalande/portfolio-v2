...
const Footer = () => {
  return (
    <>
      ...
      >
        <h2 className="text-center font-heading font-bold text-5xl text-grey uppercase sm:text-left lg:text-6xl sm:self-center">
        ...
        <div className="flex mt-3 text-center justify-center flex-col gap-4">
          ...
          <span className="flex gap-2 justify-center sm:justify-start lg:gap-4">
            <a
              ...
              className="btn-icon inline-flex items-center justify-center min-w-[44px] min-h-[44px]"
            >
